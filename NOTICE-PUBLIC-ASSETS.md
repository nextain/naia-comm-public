...
> 한국어 요약: 아래 두 파일은 소유자 승인으로 이 스냅샷에 포함된 Nextain 제품 자산입니다. Apache-2.0은 코드·문서에만 적용되며 상표·제3자 권리는 별도 조건을 따릅니다.

This history-free community snapshot includes two Nextain product assets under explicit owner authorization:

- `projects/naia-comm/site/img/naia-character.webp` — source commit `50f44448374134ac997898bb92bb1d5a4e886fe2`; SHA-256 `d8267f4948c98426834532182bf73be063b893f749731a998a36d6d852996842`.
- `projects/naia-comm/site/img/nextain-logo.png` — source commit `edb9ff148501df591eec3e5760922667278cc2eb`; SHA-256 `718205d1790938dabd64452092db8b6bcbc4fafa56c10e8314229a02652ac89b`.
